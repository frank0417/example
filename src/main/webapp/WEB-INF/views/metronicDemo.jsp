				...
				<div class="col-md-6">
					<div class="portlet blue box">
						...
						<div class="portlet-body">
							<div id="jstree_demo_div" class="tree-demo">
							</div>
						</div>
					</div>
				</div>
					...
					<div class="portlet box blue">
						...
						<div class="portlet-body">
							<div class="table-toolbar">
								<div class="btn-group">
									<button onclick="initAddUser()" id="" class="btn green">
										添加员工 <i class="fa fa-plus"></i>
									</button>
								</div>
							</div>
							<table class="table table-striped table-hover table-bordered" style="border-collapse: collapse;" id="sample_editable_1">
...
<script type="text/javascript" src="js/jsTree/metroJsTree.js"></script>
